...
public abstract class BasicProcessingRecipe<IN extends ProcessingInput<IN>, OUT extends ProcessingOutput<OUT>, RECIPE extends ProcessingRecipe<IN, OUT, RECIPE>>
        implements ProcessingRecipe<IN, OUT, RECIPE>, Cloneable {
    private IN input;
    private OUT output;
    private long processingTime;

    public BasicProcessingRecipe(IN input, OUT output) {
        this.input = input;
        this.output = output;
