...
public class ItemHelper {
    ...
    public static boolean areItemsOreDictEqual(ItemStack first, ItemStack second) {
        return areItemsAssignable(first, second) || areOreDictIdsEqual(first, second);
    }
    ...
    public static boolean areItemsEqual(ItemStack first, ItemStack second) {
        return !isEmptyOrNull(second) && areItemsEqual(first, second.getItem());
    }

    public static boolean areItemsEqual(ItemStack first, Item second) {
        return !isEmptyOrNull(first) && areItemsEqual(first.getItem(), second);
    }

    public static boolean areItemsEqual(Item first, Item second) {
        return first == second;
    }
