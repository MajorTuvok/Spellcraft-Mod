...
public class OreIdentityItemStackWrapper extends ItemStackWrapper {
    private String identityName;

    public OreIdentityItemStackWrapper(ItemStack stack) {
        super(stack);
        identityName = StringHelper.getOreIdentityName(stack);
    }
