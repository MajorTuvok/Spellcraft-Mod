package mt.mcmods.spellcraft.Client.model;
...
import mt.mcmods.spellcraft.common.registry.WandRegistry.WandRecipe;
import mt.mcmods.spellcraft.common.util.model.ModelHelper;
    ...
    public static final class BakedDynWandOverrideHandler extends ItemOverrideList {
        ...
        public static int createInventoryIcons() {
            ...
            for (Entry<ItemWand, WandRecipe> entry : WandRegistry.INSTANCE.getWandRecipeEntries()) {
                ...
                Triple<TextureAtlasSprite, AnimationMetadataSection, Integer> triple = ModelHelper.getSpriteInformation(stack);
